...
void	ProxyRwAvx2 <SplFmt_FLOAT>::read (const PtrConst::Type &ptr, __m256 &src0, __m256 &src1, const __m256i &/*zero*/)
{
	src0 = _mm256_loadu_ps (ptr    );
	src1 = _mm256_loadu_ps (ptr + 8);
}

void	ProxyRwAvx2 <SplFmt_FLOAT>::write (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &/*mask_lsb*/, const __m256i &/*sign_bit*/, const __m256 &/*offset*/)
{
	_mm256_store_ps (ptr,     src0);
	_mm256_store_ps (ptr + 8, src1);
}

void	ProxyRwAvx2 <SplFmt_FLOAT>::write_partial (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &/*mask_lsb*/, const __m256i &/*sign_bit*/, const __m256 &/*offset*/, const __m256i &/*mask_store*/)
{
	_mm256_store_ps (ptr,     src0);
	_mm256_store_ps (ptr + 8, src1);
}
...
void	ProxyRwAvx2 <SplFmt_INT8>::read (const PtrConst::Type &ptr, __m256 &src0, __m256 &src1, const __m256i &/*zero*/)
{
...
__m256i	ProxyRwAvx2 <SplFmt_INT8>::read_i16 (const PtrConst::Type &ptr, const __m256i &/*zero*/)
{
	const __m128i	src128 =
		_mm_loadu_si128 (reinterpret_cast <const __m128i *> (ptr));
	const __m256i  src    = _mm256_cvtepu8_epi16 (src128);
...
void	ProxyRwAvx2 <SplFmt_INT8>::write (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &mask_lsb, const __m256i &sign_bit, const __m256 &offset)
{
	const __m256i	val = prepare_write (src0, src1, sign_bit, offset);
	fstb::ToolsAvx2::store_16_16m (ptr, val, mask_lsb);
}

void	ProxyRwAvx2 <SplFmt_INT8>::write_partial (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &mask_lsb, const __m256i &sign_bit, const __m256 &offset, const __m256i &mask_store)
{
	const __m256i	val = prepare_write (src0, src1, sign_bit, offset);
	fstb::ToolsAvx2::store_16_16m_partial (ptr, val, mask_lsb, mask_store);
}

__m256i	ProxyRwAvx2 <SplFmt_INT8>::prepare_write (const __m256 &src0, const __m256 &src1, const __m256i &sign_bit, const __m256 &offset)
{
...
void	ProxyRwAvx2 <SplFmt_INT8>::write_i16_partial (const Ptr::Type &ptr, const __m256i &src, const __m256i &mask_lsb, const __m256i &mask_store)
{
	fstb::ToolsAvx2::store_16_16l_partial (ptr, src, mask_lsb, mask_store);
}
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
void	ProxyRwAvx2 <SplFmt_INT8>::S16 <CLIP_FLAG, SIGN_FLAG>::write_clip_partial (const Ptr::Type &ptr, const __m256i &src, const __m256i &mask_lsb, const __m256i &mi, const __m256i &ma, const __m256i &sign_bit, const __m256i &mask_store)
{
	const __m256i  val = prepare_write_clip (src, mi, ma, sign_bit);
	fstb::ToolsAvx2::store_16_16l_partial (ptr, val, mask_lsb, mask_store);
}

template <bool CLIP_FLAG, bool SIGN_FLAG>
__m256i	ProxyRwAvx2 <SplFmt_INT8>::S16 <CLIP_FLAG, SIGN_FLAG>::prepare_write_clip (const __m256i &src, const __m256i &mi, const __m256i &ma, const __m256i &sign_bit)
{
	__m256i        val = src;
	if (CLIP_FLAG)
	{
...
void	ProxyRwAvx2 <SplFmt_INT16>::read (const PtrConst::Type &ptr, __m256 &src0, __m256 &src1, const __m256i &/*zero*/)
{
	const __m256i  src =
...
//	const __m256i	sign_bit = _mm256_set1_epi16 (-0x8000);
//	const __m256	offset   = _mm256_set1_ps (-32768);
void	ProxyRwAvx2 <SplFmt_INT16>::write (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &/*mask_lsb*/, const __m256i &sign_bit, const __m256 &offset)
{
	const __m256i  val = prepare_write (src0, src1, sign_bit, offset);
	_mm256_storeu_si256 (reinterpret_cast <__m256i *> (ptr), val);
}

void	ProxyRwAvx2 <SplFmt_INT16>::write_partial (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &/*mask_lsb*/, const __m256i &sign_bit, const __m256 &offset, const __m256i &mask_store)
{
	const __m256i  val = prepare_write (src0, src1, sign_bit, offset);
	fstb::ToolsAvx2::store_partial (ptr, val, mask_store);
}

__m256i	ProxyRwAvx2 <SplFmt_INT16>::prepare_write (const __m256 &src0, const __m256 &src1, const __m256i &sign_bit, const __m256 &offset)
{
	__m256			val_0007_f = _mm256_add_ps (src0, offset);
	__m256			val_0815_f = _mm256_add_ps (src1, offset);
...
void	ProxyRwAvx2 <SplFmt_INT16>::write_i16_partial (const Ptr::Type &ptr, const __m256i &src, const __m256i &/*mask_lsb*/, const __m256i &mask_store)
{
	fstb::ToolsAvx2::store_partial (ptr, src, mask_store);
}
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
void	ProxyRwAvx2 <SplFmt_INT16>::S16 <CLIP_FLAG, SIGN_FLAG>::write_clip_partial (const Ptr::Type &ptr, const __m256i &src, const __m256i &/*mask_lsb*/, const __m256i &mi, const __m256i &ma, const __m256i &sign_bit, const __m256i &mask_store)
{
	const __m256i  val = prepare_write_clip (src, mi, ma, sign_bit);
	fstb::ToolsAvx2::store_partial (ptr, val, mask_store);
}
...
void	ProxyRwAvx2 <SplFmt_STACK16>::read (const PtrConst::Type &ptr, __m256 &src0, __m256 &src1, const __m256i &/*zero*/)
{
	const __m256i  src =
...
//	const __m256i	sign_bit = _mm256_set1_epi16 (-0x8000);
//	const __m256	offset   = _mm256_set1_ps (-32768);
void	ProxyRwAvx2 <SplFmt_STACK16>::write (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &mask_lsb, const __m256i &sign_bit, const __m256 &offset)
{
	const __m256i  val = prepare_write (src0, src1, sign_bit, offset);
...
void	ProxyRwAvx2 <SplFmt_STACK16>::write_partial (const Ptr::Type &ptr, const __m256 &src0, const __m256 &src1, const __m256i &mask_lsb, const __m256i &sign_bit, const __m256 &offset, const __m256i &mask_store)
{
	const __m256i  val = prepare_write (src0, src1, sign_bit, offset);
...
__m256i	ProxyRwAvx2 <SplFmt_STACK16>::prepare_write (const __m256 &src0, const __m256 &src1, const __m256i &sign_bit, const __m256 &offset)
{
	__m256			val_0007_f = _mm256_add_ps (src0, offset);
	__m256			val_0815_f = _mm256_add_ps (src1, offset);
...
void	ProxyRwAvx2 <SplFmt_STACK16>::write_i16_partial (const Ptr::Type &ptr, const __m256i &src, const __m256i &mask_lsb, const __m256i &mask_store)
{
...
{
	__m256i        val = fstb::ToolsAvx2::load_16_16ml (ptr._msb_ptr, ptr._lsb_ptr);
	if (SIGN_FLAG)
	{
		val = _mm256_xor_si256 (val, sign_bit);
	}
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
void	ProxyRwAvx2 <SplFmt_STACK16>::S16 <CLIP_FLAG, SIGN_FLAG>::write_clip_partial (const Ptr::Type &ptr, const __m256i &src, const __m256i &mask_lsb, const __m256i &mi, const __m256i &ma, const __m256i &sign_bit, const __m256i &mask_store)
{
	const __m256i  val = prepare_write_clip (src, mi, ma, sign_bit);
	fstb::ToolsAvx2::store_16_16ml_partial (ptr._msb_ptr, ptr._lsb_ptr, val, mask_lsb, mask_store);
}

template <bool CLIP_FLAG, bool SIGN_FLAG>
__m256i	ProxyRwAvx2 <SplFmt_STACK16>::S16 <CLIP_FLAG, SIGN_FLAG>::prepare_write_clip (const __m256i &src, const __m256i &mi, const __m256i &ma, const __m256i &sign_bit)
{
	__m256i        val = src;
	if (CLIP_FLAG)
	{
