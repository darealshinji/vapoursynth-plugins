...
// const __m128i	zero = _mm_setzero_si128 ();
void	ProxyRwSse2 <SplFmt_STACK16>::read_flt (const PtrConst::Type &ptr, __m128 &src0, __m128 &src1, const __m128i &zero)
{
	const __m128i	src =
...
// const __m128i	zero = _mm_setzero_si128 ();
void	ProxyRwSse2 <SplFmt_STACK16>::read_flt_partial (const PtrConst::Type &ptr, __m128 &src0, __m128 &src1, const __m128i &zero, int len)
{
	const __m128i	src =
		fstb::ToolsSse2::load_8_16ml_partial (ptr._msb_ptr, ptr._lsb_ptr, len);
	ProxyRwSse2 <SplFmt_INT16>::finish_read_flt (src0, src1, src, zero);
}

__m128i	ProxyRwSse2 <SplFmt_STACK16>::read_i16 (const PtrConst::Type &ptr, const __m128i &/*zero*/)
{
	return (fstb::ToolsSse2::load_8_16ml (ptr._msb_ptr, ptr._lsb_ptr));
}

__m128i	ProxyRwSse2 <SplFmt_STACK16>::read_i16_partial (const PtrConst::Type &ptr, const __m128i &/*zero*/, int len)
{
	return (fstb::ToolsSse2::load_8_16ml_partial (ptr._msb_ptr, ptr._lsb_ptr, len));
}
...
void	ProxyRwSse2 <SplFmt_STACK16>::write_flt_partial (const Ptr::Type &ptr, const __m128 &src0, const __m128 &src1, const __m128i &mask_lsb, const __m128i &sign_bit, const __m128 &offset, int len)
{
	__m128			val_03_f = _mm_add_ps (src0, offset);
	__m128			val_47_f = _mm_add_ps (src1, offset);
...
void	ProxyRwSse2 <SplFmt_STACK16>::write_i16 (const Ptr::Type &ptr, const __m128i &src, const __m128i &mask_lsb)
{
	fstb::ToolsSse2::store_8_16ml (ptr._msb_ptr, ptr._lsb_ptr, src, mask_lsb);
}

void	ProxyRwSse2 <SplFmt_STACK16>::write_i16_partial (const Ptr::Type &ptr, const __m128i &src, const __m128i &mask_lsb, int len)
{
	fstb::ToolsSse2::store_8_16ml_partial (
		ptr._msb_ptr,
		ptr._lsb_ptr,
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
__m128i	ProxyRwSse2 <SplFmt_STACK16>::S16 <CLIP_FLAG, SIGN_FLAG>::read (const PtrConst::Type &ptr, const __m128i &/*zero*/, const __m128i &sign_bit)
{
	__m128i        val =
		fstb::ToolsSse2::load_8_16ml (ptr._msb_ptr, ptr._lsb_ptr);
	if (SIGN_FLAG)
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
__m128i	ProxyRwSse2 <SplFmt_STACK16>::S16 <CLIP_FLAG, SIGN_FLAG>::read_partial (const PtrConst::Type &ptr, const __m128i &/*zero*/, const __m128i &sign_bit, int len)
{
	__m128i        val =
		fstb::ToolsSse2::load_8_16ml_partial (ptr._msb_ptr, ptr._lsb_ptr, len);
	if (SIGN_FLAG)
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
void	ProxyRwSse2 <SplFmt_STACK16>::S16 <CLIP_FLAG, SIGN_FLAG>::write_clip (const Ptr::Type &ptr, const __m128i &src, const __m128i &mask_lsb, const __m128i &mi, const __m128i &ma, const __m128i &sign_bit)
{
	const __m128i  val =
		ProxyRwSse2 <SplFmt_INT16>::S16 <CLIP_FLAG, SIGN_FLAG>::prepare_write_clip (
			src, mi, ma, sign_bit
...
template <bool CLIP_FLAG, bool SIGN_FLAG>
void	ProxyRwSse2 <SplFmt_STACK16>::S16 <CLIP_FLAG, SIGN_FLAG>::write_clip_partial (const Ptr::Type &ptr, const __m128i &src, const __m128i &mask_lsb, const __m128i &mi, const __m128i &ma, const __m128i &sign_bit, int len)
{
	const __m128i  val =
		ProxyRwSse2 <SplFmt_INT16>::S16 <CLIP_FLAG, SIGN_FLAG>::prepare_write_clip (
			src, mi, ma, sign_bit
