...
void	FilterResize::transpose_sse2 (uint16_t *dst_ptr, const uint16_t *src_ptr, int w, int h, int stride_dst, int stride_src)
{
	...
	for (int y = 0; y < h8; y += 8)
	{
		...
		for (int x = 0; x < w8; x += 8)
		{
			...
			const __m128i h = _mm_loadu_si128 (reinterpret_cast <const __m128i *> (src_ptr + stride_src * 7 + x));
			...
			const __m128i g03h03 = _mm_unpacklo_epi16 (g, h);
			...
			const __m128i g47h47 = _mm_unpackhi_epi16 (g, h);

			const __m128i a01b01c01d01 = _mm_unpacklo_epi32 (a03b03, c03d03);
			const __m128i a23b23c23d23 = _mm_unpackhi_epi32 (a03b03, c03d03);
			const __m128i e01f01g01h01 = _mm_unpacklo_epi32 (e03f03, g03h03);
			const __m128i e23f23g23h23 = _mm_unpackhi_epi32 (e03f03, g03h03);
			const __m128i a45b45c45d45 = _mm_unpacklo_epi32 (a47b47, c47d47);
			const __m128i a67b67c67d67 = _mm_unpackhi_epi32 (a47b47, c47d47);
			const __m128i e45f45g45h45 = _mm_unpacklo_epi32 (e47f47, g47h47);
			const __m128i e67f67g67h67 = _mm_unpackhi_epi32 (e47f47, g47h47);

			const __m128i a0b0c0d0e0f0g0h0 = _mm_unpacklo_epi64 (a01b01c01d01, e01f01g01h01);
			const __m128i a1b1c1d1e1f1g1h1 = _mm_unpackhi_epi64 (a01b01c01d01, e01f01g01h01);
			const __m128i a2b2c2d2e2f2g2h2 = _mm_unpacklo_epi64 (a23b23c23d23, e23f23g23h23);
			const __m128i a3b3c3d3e3f3g3h3 = _mm_unpackhi_epi64 (a23b23c23d23, e23f23g23h23);
			const __m128i a4b4c4d4e4f4g4h4 = _mm_unpacklo_epi64 (a45b45c45d45, e45f45g45h45);
			const __m128i a5b5c5d5e5f5g5h5 = _mm_unpackhi_epi64 (a45b45c45d45, e45f45g45h45);
			const __m128i a6b6c6d6e6f6g6h6 = _mm_unpacklo_epi64 (a67b67c67d67, e67f67g67h67);
			const __m128i a7b7c7d7e7f7g7h7 = _mm_unpackhi_epi64 (a67b67c67d67, e67f67g67h67);

			if (dst_align_flag)
			{
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr                 ), a0b0c0d0e0f0g0h0);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst    ), a1b1c1d1e1f1g1h1);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 2), a2b2c2d2e2f2g2h2);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 3), a3b3c3d3e3f3g3h3);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 4), a4b4c4d4e4f4g4h4);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 5), a5b5c5d5e5f5g5h5);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 6), a6b6c6d6e6f6g6h6);
				_mm_store_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 7), a7b7c7d7e7f7g7h7);
			}
			else
			{
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr                 ), a0b0c0d0e0f0g0h0);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst    ), a1b1c1d1e1f1g1h1);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 2), a2b2c2d2e2f2g2h2);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 3), a3b3c3d3e3f3g3h3);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 4), a4b4c4d4e4f4g4h4);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 5), a5b5c5d5e5f5g5h5);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 6), a6b6c6d6e6f6g6h6);
				_mm_storeu_si128 (reinterpret_cast <__m128i *> (dst_2_ptr + stride_dst * 7), a7b7c7d7e7f7g7h7);
			}
