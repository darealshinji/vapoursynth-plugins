...
private:
	...
	static fstb_FORCEINLINE void
	               process_vect_flt_sse (__m128 &sum0, __m128 &sum1, int kernel_size, const float *coef_base_ptr, typename SRC::PtrConst::Type pix_ptr, const __m128i &zero, int src_stride, const __m128 &add_cst);
#endif
	...
	template <class SRC>
	static fstb_FORCEINLINE void
	               process_vect_flt_avx (__m256 &sum0, __m256 &sum1, int kernel_size, const float *coef_base_ptr, typename SRC::PtrConst::Type pix_ptr, const __m256i &zero, int src_stride, const __m256 &add_cst);
