...
template<typename T>
void copyPlane_avx2(const T * srcp, float * blur, const int width, const int height, const int stride, const int bgStride, const float offset) noexcept {
...
template void copyPlane_avx2(const uint8_t *, float *, const int, const int, const int, const int, const float) noexcept;
template void copyPlane_avx2(const uint16_t *, float *, const int, const int, const int, const int, const float) noexcept;
template void copyPlane_avx2(const float *, float *, const int, const int, const int, const int, const float) noexcept;

static inline void gaussianBlurH_avx2(float * buffer, float * blur, const float * weights, const int width, const int radius) noexcept {
    weights += radius;
...
template<typename T>
void gaussianBlurV_avx2(const T * __srcp, float * buffer, float * blur, const float * horizontalWeights, const float * verticalWeights,
    ...
    for (int y = 0; y < height; y++) {
        ...
        gaussianBlurH_avx2(buffer, blur, horizontalWeights, width, horizontalRadius);
...
template void gaussianBlurV_avx2(const uint8_t *, float *, float *, const float *, const float *, const int, const int, const int, const int, const int, const int, const float) noexcept;
template void gaussianBlurV_avx2(const uint16_t *, float *, float *, const float *, const float *, const int, const int, const int, const int, const int, const int, const float) noexcept;
template void gaussianBlurV_avx2(const float *, float *, float *, const float *, const float *, const int, const int, const int, const int, const int, const int, const float) noexcept;

void detectEdge_avx2(float * blur, float * gradient, unsigned * direction, const int width, const int height, const int stride, const int bgStride,
...
void nonMaximumSuppression_avx2(const unsigned * _direction, float * _gradient, float * blur, const int width, const int height, const int stride, const int bgStride) noexcept {
...
template<typename T> void outputGB_avx2(const float *, T *, const int, const int, const int, const int, const uint16_t, const float) noexcept;

template<>
void outputGB_avx2(const float * blur, uint8_t * dstp, const int width, const int height, const int stride, const int bgStride, const uint16_t peak, const float offset) noexcept {
    for (int y = 0; y < height; y++) {
...
template<>
void outputGB_avx2(const float * blur, uint16_t * dstp, const int width, const int height, const int stride, const int bgStride, const uint16_t peak, const float offset) noexcept {
    for (int y = 0; y < height; y++) {
...
template<>
void outputGB_avx2(const float * blur, float * dstp, const int width, const int height, const int stride, const int bgStride, const uint16_t peak, const float offset) noexcept {
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x += 8) {
...
template<typename T> void binarizeCE_avx2(const float *, T *, const int, const int, const int, const int, const uint16_t, const float, const float) noexcept;

template<>
void binarizeCE_avx2(const float * blur, uint8_t * dstp, const int width, const int height, const int stride, const int bgStride,
    ...
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x += 32) {
            ...
            const Vec8ib mask_8ib_2 = Vec8ib(Vec8f().load_a(blur + x + 16) == fltMax);
            const Vec8ib mask_8ib_3 = Vec8ib(Vec8f().load_a(blur + x + 24) == fltMax);
...
template<>
void binarizeCE_avx2(const float * blur, uint16_t * dstp, const int width, const int height, const int stride, const int bgStride,
                     const uint16_t peak, const float lower, const float upper) noexcept {
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x += 16) {
            const Vec8ib mask_8ib_0 = Vec8ib(Vec8f().load_a(blur + x) == fltMax);
...
template<>
void binarizeCE_avx2(const float * blur, float * dstp, const int width, const int height, const int stride, const int bgStride,
                     const uint16_t peak, const float lower, const float upper) noexcept {
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x += 8) {
...
template<typename T> void discretizeGM_avx2(const float *, T *, const int, const int, const int, const int, const float, const uint16_t, const float) noexcept;

template<>
void discretizeGM_avx2(const float * gradient, uint8_t * dstp, const int width, const int height, const int stride, const int bgStride,
...
template<>
void discretizeGM_avx2(const float * gradient, uint16_t * dstp, const int width, const int height, const int stride, const int bgStride,
                       const float magnitude, const uint16_t peak, const float offset) noexcept {
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x += 16) {
            const Vec8f srcp_8f_0 = Vec8f().load_a(gradient + x);
...
template<>
void discretizeGM_avx2(const float * gradient, float * dstp, const int width, const int height, const int stride, const int bgStride,
                       const float magnitude, const uint16_t peak, const float offset) noexcept {
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x += 8) {
